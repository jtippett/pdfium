defmodule Pdfium do
  ...
  defp image_for("29", "glibc"), do: "hexpm/elixir:1.20-erlang-29.0.1-ubuntu-noble-20260410"
  defp image_for("29", "musl"), do: "hexpm/elixir:1.20-erlang-29.0.1-alpine-3.23.4"
